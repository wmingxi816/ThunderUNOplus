import type { GameCommand } from "@thunder-uno/shared-types";
import type { GameState, PlayerId } from "@thunder-uno/shared-types";
...
export interface DecideGreedyBotActionParams extends BotStrategyParams {
  state: GameState;
  playerId: PlayerId;
